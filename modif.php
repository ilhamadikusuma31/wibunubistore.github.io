...
$barang = query_nya("SELECT * FROM barang WHERE barang_id = $id")[0];
            ...
            <div class="col-md-6">                                      
              <form name="contact-form" action="" method="post" enctype ="multipart/form-data">
                ...
                <div class="mb-md-1">
                  ...
                  <img src="img/katalog/<?= $barang["gambar"]  ?>" alt="" width="200px" class="me-auto ms-auto"/>
                  <input type="file" class="form-control" id="gambar" aria-describedby="gambar" name="gambar" />
                </div>
                <div class="mb-md-1">
                ...
                <div class="mb-md-1">
                  ...
                  <input type="text" class="form-control" id="deskripsi" aria-describedby="deskripsi" name="deskripsi" value="<?= $barang['deskripsi']  ?>" />
                </div>
                <div class="mb-md-1">
                  <label for="nama_barang" class="form-label">Nama Barang</label>
                  <input type="text" class="form-control" id="nama_barang" aria-describedby="nama_barang" name="nama_barang" value="<?= $barang['nama_barang']  ?>" />
                </div>
                <div class="mb-md-1">
                  <label for="harga" class="form-label">Harga</label>
                  <input type="text" class="form-control" id="harga" aria-describedby="harga" name="harga" value="<?= $barang['harga']  ?>" />
                </div>
                <div class="mb-md-1">
                  <label for="berat" class="form-label">Berat</label>
                  <input type="text" class="form-control" id="berat" aria-describedby="berat" name="berat" value="<?= $barang['berat']  ?>" />
                </div>
                <div class="mb-md-1">
